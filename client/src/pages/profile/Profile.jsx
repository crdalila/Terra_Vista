    ...
    return (
        <article className="article my-profile">
            <section className="my-profile--left">
                ...
                <button className="edit-password-button" onClick={() => document.querySelector('.my-profile--right').classList.toggle('hidden')}>
                    Edit Password
            ...
            <section className="my-profile--right hidden">
                <form onSubmit={handleSubmit} method="post" className="edit-password-form hidden">
