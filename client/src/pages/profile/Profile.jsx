    ...
    return (
        <article className="article my-profile">
            ...
            <button className="edit-password-button" onClick={() => handleEditPassword()}>
                Edit Password
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="var(--main-color)" width='20' height='20'>
            ...
            <section className="my-profile-right hidden">
                <h3>Edit Password</h3>
                <form action="" onSubmit={handleSubmit} method="post" className="edit-password-form">
                    ...
                    <button type="submit" className="submit-password">Save Changes<i>!</i></button>
                </form>
            </section>
        </article>
    );
