    ...
    return (
        <article className="footer">
            <section className="footer-info">
                <div className="footer-info__item">
                    ...
                    <div className="footer-info__links">
                        <a href='https://www.instagram.com/terra.agency.hq/' target="_blank" className="footer-link button">
                        ...
                        <a href="https://www.linkedin.com/company/terra-agency-hq/" target="_blank" className="footer-link button">
            ...
            <section className="footer-copyright">
                <p>© 2025 Terra Vista. All Rights Reserved.</p>
            </section>
        </article>
    );
}
